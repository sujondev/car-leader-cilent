...
const CarBuyOpportunity = () => {
    return (
        <div>
            <div className="bg-img mt-5 h-[480px]" style={{ backgroundImage: `url(${bgimg1})` }}>
                ...
                <div className='grid grid-cols-2 gap-y-6 p-10'>
                    <div className='flex'>
                        <div className=' bg-primary text-white p-3 rounded-full mr-5'>
